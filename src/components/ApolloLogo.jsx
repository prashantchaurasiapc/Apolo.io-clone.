...
export default function ApolloLogo({ className = "", height = 28, showText = true }) {
  return (
    <div className={`flex items-center gap-2.5 ${className}`} style={{ display: 'inline-flex', alignItems: 'center' }}>
      <svg 
        height={height} 
        viewBox="0 0 36 36" 
        fill="none" 
